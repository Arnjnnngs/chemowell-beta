...
`index.html` md5 `2ed1d5869bd5f882d2cd6544af8274f6` · `sw.js` CACHE `chemowell-beta-v62`
...
> `harness-med-purpose-patch.py`; the gate is `harness/med-purpose-test.mjs` (53/53).
>
