...
> `harness-med-purpose-patch.py`; the gate is `harness/med-purpose-test.mjs` (40/40).
>
...
> checks now prove each guard can fire. A green check nobody has proved can go red is not evidence.
